...
/***/ function(module, exports, __webpack_require__) {
		...
		_createClass(Counter, [{
			...
			value: function render() {
				return _react2.default.createElement(
					...
					_react2.default.createElement(
						'button',
						{ onClick: this.reduceHandler.bind(this) },
						'减一'
					),
					_react2.default.createElement(
						'button',
						{ onClick: this.addIfOdd.bind(this) },
						'奇数加一'
					),
					_react2.default.createElement(
						'button',
						{ onClick: this.addAsync.bind(this) },
						'异步加一'
					)
				);
			}
			...
			value: function addAsync() {
				...
				setTimeout(function () {
					var count = _this2.props.count;
					_this2.props.add(++count);
				}, 1000);
			}
		}]);
	...
	exports.default = (0, _reactRedux.connect)(mapStateToProps, actions)(Counter);
...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, "body, html, div, span, button {\n  margin: 0;\n  padding: 0; }\n\nbutton {\n  -webkit-appearance: none;\n  -moz-appearance: none;\n  -o-appearance: none;\n  -ms-appearance: none;\n  appearance: none; }\n\n.ui-btn, #box button {\n  background-color: #dc1414;\n  background-image: -webkit-gradient(linear, left top, left bottom, color-stop(0.5, #dc1414), to(#dc1414));\n  color: #fff;\n  border-color: #dc1414;\n  border-radius: 3px;\n  height: 25px;\n  line-height: 25px;\n  border: none;\n  padding: 0 10px;\n  font-size: 13px;\n  cursor: pointer; }\n\n.space, #box, #box span, #box button {\n  margin: 10px; }\n\n#box span, #box button {\n  outline: none; }\n\n#box button {\n  -webkit-background-clip: padding-box;\n  -moz-background-clip: padding-box;\n  -o-background-clip: padding-box;\n  -ms-background-clip: padding-box;\n  background-clip: padding-box; }\n", ""]);
